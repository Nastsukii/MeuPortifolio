...
/**
 * Interface das propriedades da página de Contato
 */
 ...
 * Exibe informações de contato, links sociais (LinkTree) e um formulário de envio de mensagem.
 */
const Contato = ({ businessSettings, generalSettings, linkTreeData }: ContatoProps) => {
  const { t } = useLanguage();
  
  /**
   * Retorna o ícone SVG correspondente ao nome do ícone.
   * Usado para renderizar ícones dinamicamente baseados na configuração (CMS/JSON).
   */
  ...
  return (
    <>
      ...
      <div className="min-h-screen">
        ...
        {/* Seção de Disponibilidade (Indicadores) */}
        <PageSection
